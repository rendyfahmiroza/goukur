...
<div class="container-fluid animatedParent animateOnce p-0">
                ...
                <table class="table table-striped table-hover r-0 mt-5">
                    <tbody>
                        <tr v-for="(item, index) in listPetugas" :key="index">
                            ...
                            <td align="right">
                                <router-link :to="{ name:'perbaiki-petugas', params: {id: item.id}}" class="btn-fab btn-fab-sm btn-primary shadow text-white mr-2"><i class="icon-pencil"></i></router-link>
    ...
    <router-link :to="{ name: 'tambah-petugas' }" class="btn-fab btn-fab-md fab-right fab-right-bottom-fixed shadow btn-primary"><i class="icon-add"></i></router-link>
</div>
</template>
