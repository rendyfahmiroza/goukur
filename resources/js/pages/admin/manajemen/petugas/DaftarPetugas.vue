                    ...
                    <tbody>
                        <tr v-for="(item, index) in listPetugas" :key="index">
                            ...
                            <td align="right" class="pl-md-5">
                                <div>
                                    <div>
                                        <small><span class="avatar-badge busy"></span><i class="icon-circle text-red mr-2"></i> Batal: </small> 
                                        <strong class="h6">{{item.batal}} Berkas</strong>
                                    </div>
                                </div>
                            </td>
                            <td align="right" class="pl-md-5">
                                <div>
                                    <div>
                                        <small><span class="avatar-badge busy"></span><i class="icon-circle text-warning mr-2"></i> Proses: </small> 
                            ...
                            <td align="right" class="pl-md-5">
                                <div>
                                    <div>
                                        <small><span class="avatar-badge busy"></span><i class="icon-circle text-success mr-2"></i> Selesai: </small> 
                                        <strong class="h6">{{item.selesai}} Berkas</strong>
                                    </div>
                                </div>
                            </td>
