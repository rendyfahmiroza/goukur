                    ...
                    <ul class="sidebar-menu">
                        <li class="treeview"><a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="panel-page-products.html"><i class="icon icon-circle-o"></i>Semua Berkas</a>
                                </li>
                                <li><a href="panel-page-products-create.html"><i class="icon icon-add"></i>Tambah Baru </a>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview"><a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="panel-page-products.html"><i class="icon icon-circle-o"></i>Kabupaten/Kota</a>
                                </li>
                                <li><a href="panel-page-products-create.html"><i class="icon icon-circle-o"></i>Kecamatan</a>
                                </li>
                                <li><a href="panel-page-products-create.html"><i class="icon icon-circle-o"></i>Desa</a>
                                </li>
                                <li><a href="panel-page-products-create.html"><i class="icon icon-circle-o"></i>PPAT</a>
                                </li>
                                <li><a href="panel-page-products-create.html"><i class="icon icon-circle-o"></i>Petugas Ukur</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                                    ...
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{ asset('/img/dummy/u1.png') }}" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{ asset('/img/dummy/u6.png') }}" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{ asset('/img/dummy/u2.png') }}" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{ asset('/img/dummy/u3.png') }}" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="{{ asset('/img/dummy/u4.png') }}" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
