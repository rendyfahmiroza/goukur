                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <figure class="avatar">
                                    <img src="{{ asset('/img/dummy/u12.png') }}" alt=""></figure>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <figure class="avatar">
                                    <img src="{{ asset('/img/dummy/u2.png') }}" alt=""></figure>
                            </div>
                            <div class="progress progress-xs mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="avatar-group">
                                    <figure class="avatar">
                                        <img src="{{ asset('/img/dummy/u4.png') }}" alt=""></figure>
                                    <figure class="avatar">
                                        <img src="{{ asset('/img/dummy/u11.png') }}" alt=""></figure>
                                    <figure class="avatar">
                                        <img src="{{ asset('/img/dummy/u1.png') }}" alt=""></figure>
                                </div>
                            </div>
                            <div class="progress progress-xs mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <figure class="avatar">
                                    <img src="{{ asset('/img/dummy/u5.png') }}" alt=""></figure>
                            </div>
                            <div class="progress progress-xs mb-3">
                ...
                <div class="card-body">
                    <table class="table table-hover earning-box">
                        ...
                        <tr class="no-b">
                            <td class="w-10">
                                <a href="panel-page-profile.html" class="avatar avatar-lg">
                                    <img src="{{ asset('/img/dummy/u6.png') }}" alt="">
                                </a>
                            </td>
                            <td>
                                <h6>Sara Kamzoon</h6>
                        ...
                        <tr>
                            <td class="w-10">
                                <a href="panel-page-profile.html" class="avatar avatar-lg">
                                    <img src="{{ asset('/img/dummy/u9.png') }}" alt="">
                                </a>
                            </td>
                            <td>
                                <h6>Sara Kamzoon</h6>
                        ...
                        <tr>
                            <td class="w-10">
                                <a href="panel-page-profile.html" class="avatar avatar-lg">
                                    <img src="{{ asset('/img/dummy/u11.png') }}" alt="">
                                </a>
                            </td>
                            <td>
                                <h6>Sara Kamzoon</h6>
                        ...
                        <tr>
                            <td class="w-10">
                                <a href="panel-page-profile.html" class="avatar avatar-lg">
                                    <img src="{{ asset('/img/dummy/u12.png') }}" alt="">
                                </a>
                            </td>
                            <td>
                                <h6>Sara Kamzoon</h6>
                        ...
                        <tr>
                            <td class="w-10">
                                <a href="panel-page-profile.html" class="avatar avatar-lg">
                                    <img src="{{ asset('/img/dummy/u5.png') }}" alt="">
                                </a>
                            </td>
                            <td>
                                <h6>Sara Kamzoon</h6>
