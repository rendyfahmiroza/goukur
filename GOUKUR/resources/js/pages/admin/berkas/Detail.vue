                        ...
                        <div class="p-5" v-if="loaded">
                            ...
                            <div class="row no-print">
                                <div class="col-12" v-if="statusProses != 'batal' && statusProses != 'selesai'">
                                    ...
                                    <button v-if="$auth.user().hak_akses == 1 || $auth.user().hak_akses == 2 && statusProses != 'batal'" @click="konfirmasiBerkas('tunda')" type="button" class="btn btn-warning btn-lg  float-right mr-2"><i class="icon icon-schedule"></i> Tunda
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        getData: function () {
            ...
            get('/berkas/' + this.id)
                .then(res => {
                    ...
                    this.pembatalan = res.data.pembatalan
