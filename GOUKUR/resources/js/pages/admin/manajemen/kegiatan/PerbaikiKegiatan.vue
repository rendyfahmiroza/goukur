                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="">
                                                ...
                                                <input v-model="namaKegiatan" type="text" class="form-control" required focus/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
...
export default {
    ...
    methods: {
        getData: function () {
            // Get data
            axios.
                get('/kegiatan/'+ this.id)
                .then(res => {
                    console.log(res)
                    this.namaKegiatan = res.data.kegiatan
                    this.statusKegiatan = res.data.status
                })
        },
        postData: function () {
            let params = {
