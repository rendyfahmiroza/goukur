                        ...
                        <form class="">
                            ...
                            <div class="body mt-1 pt-2">
                                <div class="row clearfix ">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input v-model="nip" type="text" class="form-control" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12" v-if="$auth.user().hak_akses == 1">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <label class="form-label">* Pangkat/Gologan ( Pengatur Muda/(IIa) )</label>
                                                <input v-model="golongan" type="text" class="form-control"  placeholder="" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
        ...
        getData: function() {
            ...
            axios.
                ...
                .then(res => {
                    ...
                    this.kantah = res.data.kantah,
                    this.no_telepon = res.data.no_telepon,
                    this.telegram_id = res.data.telegram_id,
        ...
        postData: function () {
            if (this.password != "" && (this.password != this.repassword)) {
                ...
                let params = {
                    ...
                    kantah: this.$auth.user().hak_akses == 1 ? this.kantah : this.$auth.user().kantah,
