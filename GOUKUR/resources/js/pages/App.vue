                    ...
                    <div class="teal accent-4 text-white">
                        <div class="nav mt-5 pt-5 flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <div v-if="$auth.user().hak_akses == 1 || $auth.user().hak_akses == 2">
                                ...
                                <router-link class="nav-link text-yellow" :to="{ name: 'berkas-mandiri' }"><i class="icon-fiber_new"></i></router-link>
                            </div>
                            ...
                            <div class="relative brand-wrapper sticky b-b">
                                <div class="d-flex justify-content-between align-items-center p-3">
                                    <div class="text-xs-center">
                                        <span class="font-weight-lighter s-18">Admin</span>
                                    </div>
                                </div>
                            </div>
                            <ul class="sidebar-menu">
                                <li v-if="$auth.user().hak_akses == 1"><router-link :to="{ name: 'berkas' }">
                                        <i class="icon icon icon-package s-24"></i>
                                        <span>Berkas</span>
                                        <!-- <span class="badge r-3 badge-primary pull-right">4</span> -->
                                    </router-link>
                                </li>
                                <li class="treeview active"><a href="#" class="active">
                                        <i class="icon icon icon-package s-24"></i>
                                        <span>Manajemen</span>
                                        <!-- <span class="badge r-3 badge-primary pull-right">4</span> -->
                                    </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown custom-dropdown messages-menu">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <ul class="menu pl-2 pr-2">
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <h4>
                                                        Maintenance
                                                        <small><i class="icon icon-clock-o"></i> - Hari</small>
                                                    </h4>
                                    ...
                                    <li class="footer s-12 p-2 text-center"><a href="#">Lihat semua pesan</a></li>
                                </ul>
                            </li>
                            <!-- User Account-->
